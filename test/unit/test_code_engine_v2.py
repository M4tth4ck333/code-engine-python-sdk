...
class TestListAllowedOutboundDestinations:
    ...
    def test_list_allowed_outbound_destinations_all_params(self):
        ...
        mock_response = '{"allowed_outbound_destinations": [{"entity_tag": "2385407409", "name": "allow-all", "project_id": "4e49b3e0-27a8-48d2-a784-c7ee48bb863b", "status": "ready", "status_details": {"endpoint_gateway": {"account_id": "4329073d16d2f3663f74bfa955259139", "created_at": "2025-09-13T11:41:35+02:00", "ips": ["ips"], "name": "my-endpoint-gateway"}, "private_path_service_gateway": {"id": "r006-7268d425-59b7-48fd-9735-81a7271657d5", "name": "my-private-path-service-gateway", "service_endpoints": ["service_endpoints"]}, "reason": "ready"}, "type": "cidr_block", "cidr_block": "cidr_block"}], "first": {"href": "href"}, "limit": 100, "next": {"href": "href", "start": "start"}}'
        responses.add(
            responses.GET,
            url,
            body=mock_response,
    ...
    def test_list_allowed_outbound_destinations_with_pager_get_next(self):
        ...
        # Set up a two-page mock response
        url = preprocess_url('/projects/15314cc3-85b4-4338-903f-c28cdee6d005/allowed_outbound_destinations')
        mock_response1 = '{"next":{"start":"1"},"allowed_outbound_destinations":[{"entity_tag":"2385407409","name":"allow-all","project_id":"4e49b3e0-27a8-48d2-a784-c7ee48bb863b","status":"ready","status_details":{"endpoint_gateway":{"account_id":"4329073d16d2f3663f74bfa955259139","created_at":"2025-09-13T11:41:35+02:00","ips":["ips"],"name":"my-endpoint-gateway"},"private_path_service_gateway":{"id":"r006-7268d425-59b7-48fd-9735-81a7271657d5","name":"my-private-path-service-gateway","service_endpoints":["service_endpoints"]},"reason":"ready"},"type":"cidr_block","cidr_block":"cidr_block"}],"total_count":2,"limit":1}'
        mock_response2 = '{"allowed_outbound_destinations":[{"entity_tag":"2385407409","name":"allow-all","project_id":"4e49b3e0-27a8-48d2-a784-c7ee48bb863b","status":"ready","status_details":{"endpoint_gateway":{"account_id":"4329073d16d2f3663f74bfa955259139","created_at":"2025-09-13T11:41:35+02:00","ips":["ips"],"name":"my-endpoint-gateway"},"private_path_service_gateway":{"id":"r006-7268d425-59b7-48fd-9735-81a7271657d5","name":"my-private-path-service-gateway","service_endpoints":["service_endpoints"]},"reason":"ready"},"type":"cidr_block","cidr_block":"cidr_block"}],"total_count":2,"limit":1}'
        responses.add(
            responses.GET,
            url,
            body=mock_response1,
...
class TestCreateAllowedOutboundDestination:
    ...
    def test_create_allowed_outbound_destination_all_params(self):
        ...
        # Set up mock
        url = preprocess_url('/projects/15314cc3-85b4-4338-903f-c28cdee6d005/allowed_outbound_destinations')
        mock_response = '{"entity_tag": "2385407409", "name": "allow-all", "project_id": "4e49b3e0-27a8-48d2-a784-c7ee48bb863b", "status": "ready", "status_details": {"endpoint_gateway": {"account_id": "4329073d16d2f3663f74bfa955259139", "created_at": "2025-09-13T11:41:35+02:00", "ips": ["ips"], "name": "my-endpoint-gateway"}, "private_path_service_gateway": {"id": "r006-7268d425-59b7-48fd-9735-81a7271657d5", "name": "my-private-path-service-gateway", "service_endpoints": ["service_endpoints"]}, "reason": "ready"}, "type": "cidr_block", "cidr_block": "cidr_block"}'
        responses.add(
            responses.POST,
            url,
            body=mock_response,
...
class TestGetProjectStatusDetails:
    ...
    def test_get_project_status_details_all_params(self):
        ...
        mock_response = '{"cbr": {"data_plane": {"enforcement": "applied", "inbound_private": "blocked", "inbound_public": "blocked", "last_synced_at": "last_synced_at"}}, "domain": "unknown", "project": "enabled", "vpe": "ready", "vpe_not_enabled": false}'
        responses.add(
            responses.GET,
            url,
            body=mock_response,
...
class TestCreateApp:
    ...
    def test_create_app_all_params(self):
        ...
        volume_mount_prototype_model['read_only'] = True
        volume_mount_prototype_model['reference'] = 'my-secret'
        volume_mount_prototype_model['sub_path'] = 'some-path'
...
class TestListFunctionRuntimes:
    ...
    def test_list_function_runtimes_all_params(self):
        ...
        mock_response = '{"function_runtimes": [{"default": true, "deprecated": false, "family": "nodejs", "id": "nodejs-24", "name": "Node.js 24", "optimized": true}]}'
        responses.add(
            responses.GET,
            url,
            body=mock_response,
...
class TestCreateFunction:
    ...
    def test_create_function_all_params(self):
        ...
        assert req_body['runtime'] == 'nodejs-24'
...
class TestUpdateFunction:
    ...
    def test_update_function_all_params(self):
        ...
        function_patch_model['runtime'] = 'nodejs-24'
...
##############################################################################
# Start of Service: PersistentDataStores
##############################################################################
# region
...
class TestListPersistentDataStores:
    ...
    def test_list_persistent_data_stores_all_params(self):
        ...
        mock_response = '{"first": {"href": "href"}, "limit": 100, "next": {"href": "href", "start": "start"}, "persistent_data_stores": [{"created_at": "2022-09-13T11:41:35+02:00", "data": {"bucket_location": "bucket_location", "bucket_name": "bucket_name", "secret_name": "secret_name"}, "entity_tag": "2385407409", "href": "https://api.eu-de.codeengine.cloud.ibm.com/v2/projects/4e49b3e0-27a8-48d2-a784-c7ee48bb863b/persistent_data_stores/my-persistent-data-store", "id": "e33b1cv7-7390-4437-a5c2-130d5ccdddc3", "name": "my-persistent-data-store", "project_id": "4e49b3e0-27a8-48d2-a784-c7ee48bb863b", "region": "us-east", "resource_type": "persistent_data_store_v2", "storage_type": "object_storage"}]}'
        responses.add(
            responses.GET,
            url,
            body=mock_response,
...
class TestCreatePersistentDataStore:
    """
    Test Class for create_persistent_data_store
    """

    @responses.activate
    def test_create_persistent_data_store_all_params(self):
        """
        create_persistent_data_store()
        """
        # Set up mock
        url = preprocess_url('/projects/15314cc3-85b4-4338-903f-c28cdee6d005/persistent_data_stores')
        mock_response = '{"created_at": "2022-09-13T11:41:35+02:00", "data": {"bucket_location": "bucket_location", "bucket_name": "bucket_name", "secret_name": "secret_name"}, "entity_tag": "2385407409", "href": "https://api.eu-de.codeengine.cloud.ibm.com/v2/projects/4e49b3e0-27a8-48d2-a784-c7ee48bb863b/persistent_data_stores/my-persistent-data-store", "id": "e33b1cv7-7390-4437-a5c2-130d5ccdddc3", "name": "my-persistent-data-store", "project_id": "4e49b3e0-27a8-48d2-a784-c7ee48bb863b", "region": "us-east", "resource_type": "persistent_data_store_v2", "storage_type": "object_storage"}'
        responses.add(
            responses.POST,
            url,
            body=mock_response,
        ...
        data = storage_data_model

        # Invoke method
        response = _service.create_persistent_data_store(
            project_id,
            name,
            storage_type,
            data=data,
        ...
        # Validate body params
        req_body = json.loads(str(responses.calls[0].request.body, 'utf-8'))
        assert req_body['name'] == 'my-persistent-data-store'
        assert req_body['storage_type'] == 'object_storage'
        assert req_body['data'] == storage_data_model

    def test_create_persistent_data_store_all_params_with_retries(self):
        # Enable retries and run test_create_persistent_data_store_all_params.
        _service.enable_retries()
        self.test_create_persistent_data_store_all_params()

        # Disable retries and run test_create_persistent_data_store_all_params.
        _service.disable_retries()
        self.test_create_persistent_data_store_all_params()

    @responses.activate
    def test_create_persistent_data_store_required_params(self):
        """
        test_create_persistent_data_store_required_params()
        """
        # Set up mock
        url = preprocess_url('/projects/15314cc3-85b4-4338-903f-c28cdee6d005/persistent_data_stores')
        mock_response = '{"created_at": "2022-09-13T11:41:35+02:00", "data": {"bucket_location": "bucket_location", "bucket_name": "bucket_name", "secret_name": "secret_name"}, "entity_tag": "2385407409", "href": "https://api.eu-de.codeengine.cloud.ibm.com/v2/projects/4e49b3e0-27a8-48d2-a784-c7ee48bb863b/persistent_data_stores/my-persistent-data-store", "id": "e33b1cv7-7390-4437-a5c2-130d5ccdddc3", "name": "my-persistent-data-store", "project_id": "4e49b3e0-27a8-48d2-a784-c7ee48bb863b", "region": "us-east", "resource_type": "persistent_data_store_v2", "storage_type": "object_storage"}'
    ...
    def test_create_persistent_data_store_required_params_with_retries(self):
        # Enable retries and run test_create_persistent_data_store_required_params.
        _service.enable_retries()
        self.test_create_persistent_data_store_required_params()

        # Disable retries and run test_create_persistent_data_store_required_params.
        _service.disable_retries()
        self.test_create_persistent_data_store_required_params()

    @responses.activate
    def test_create_persistent_data_store_value_error(self):
        """
        test_create_persistent_data_store_value_error()
        """
        # Set up mock
        url = preprocess_url('/projects/15314cc3-85b4-4338-903f-c28cdee6d005/persistent_data_stores')
        mock_response = '{"created_at": "2022-09-13T11:41:35+02:00", "data": {"bucket_location": "bucket_location", "bucket_name": "bucket_name", "secret_name": "secret_name"}, "entity_tag": "2385407409", "href": "https://api.eu-de.codeengine.cloud.ibm.com/v2/projects/4e49b3e0-27a8-48d2-a784-c7ee48bb863b/persistent_data_stores/my-persistent-data-store", "id": "e33b1cv7-7390-4437-a5c2-130d5ccdddc3", "name": "my-persistent-data-store", "project_id": "4e49b3e0-27a8-48d2-a784-c7ee48bb863b", "region": "us-east", "resource_type": "persistent_data_store_v2", "storage_type": "object_storage"}'
        ...
        for param in req_param_dict.keys():
            req_copy = {key: val if key is not param else None for (key, val) in req_param_dict.items()}
            with pytest.raises(ValueError):
                _service.create_persistent_data_store(**req_copy)

    def test_create_persistent_data_store_value_error_with_retries(self):
        # Enable retries and run test_create_persistent_data_store_value_error.
        _service.enable_retries()
        self.test_create_persistent_data_store_value_error()

        # Disable retries and run test_create_persistent_data_store_value_error.
        _service.disable_retries()
        self.test_create_persistent_data_store_value_error()


class TestDeletePersistentDataStore:
    """
    Test Class for delete_persistent_data_store
    """

    @responses.activate
    def test_delete_persistent_data_store_all_params(self):
        """
        delete_persistent_data_store()
        """
        # Set up mock
        url = preprocess_url(
        ...
        # Invoke method
        response = _service.delete_persistent_data_store(
            project_id,
            name,
            headers={},
        )
    ...
    def test_delete_persistent_data_store_all_params_with_retries(self):
        # Enable retries and run test_delete_persistent_data_store_all_params.
        _service.enable_retries()
        self.test_delete_persistent_data_store_all_params()

        # Disable retries and run test_delete_persistent_data_store_all_params.
        _service.disable_retries()
        self.test_delete_persistent_data_store_all_params()

    @responses.activate
    def test_delete_persistent_data_store_required_params(self):
        """
        test_delete_persistent_data_store_required_params()
        """
        # Set up mock
        url = preprocess_url(
            '/projects/15314cc3-85b4-4338-903f-c28cdee6d005/persistent_data_stores/my-persistent-data-store'
    ...
    def test_delete_persistent_data_store_required_params_with_retries(self):
        # Enable retries and run test_delete_persistent_data_store_required_params.
        _service.enable_retries()
        self.test_delete_persistent_data_store_required_params()

        # Disable retries and run test_delete_persistent_data_store_required_params.
        _service.disable_retries()
        self.test_delete_persistent_data_store_required_params()

    @responses.activate
    def test_delete_persistent_data_store_value_error(self):
        """
        test_delete_persistent_data_store_value_error()
        """
        # Set up mock
        url = preprocess_url(
            '/projects/15314cc3-85b4-4338-903f-c28cdee6d005/persistent_data_stores/my-persistent-data-store'
        ...
        for param in req_param_dict.keys():
            req_copy = {key: val if key is not param else None for (key, val) in req_param_dict.items()}
            with pytest.raises(ValueError):
                _service.delete_persistent_data_store(**req_copy)

    def test_delete_persistent_data_store_value_error_with_retries(self):
        # Enable retries and run test_delete_persistent_data_store_value_error.
        _service.enable_retries()
        self.test_delete_persistent_data_store_value_error()

        # Disable retries and run test_delete_persistent_data_store_value_error.
        _service.disable_retries()
        self.test_delete_persistent_data_store_value_error()


class TestGetPersistentDataStore:
    """
    Test Class for get_persistent_data_store
    """

    @responses.activate
    def test_get_persistent_data_store_all_params(self):
        """
        get_persistent_data_store()
        """
        # Set up mock
        url = preprocess_url(
            '/projects/15314cc3-85b4-4338-903f-c28cdee6d005/persistent_data_stores/my-persistent-data-store'
        ...
        # Invoke method
        response = _service.get_persistent_data_store(
            project_id,
            name,
            headers={},
        )
    ...
    def test_get_persistent_data_store_all_params_with_retries(self):
        # Enable retries and run test_get_persistent_data_store_all_params.
        _service.enable_retries()
        self.test_get_persistent_data_store_all_params()

        # Disable retries and run test_get_persistent_data_store_all_params.
        _service.disable_retries()
        self.test_get_persistent_data_store_all_params()

    @responses.activate
    def test_get_persistent_data_store_required_params(self):
        """
        test_get_persistent_data_store_required_params()
        """
        # Set up mock
        url = preprocess_url(
            '/projects/15314cc3-85b4-4338-903f-c28cdee6d005/persistent_data_stores/my-persistent-data-store'
    ...
    def test_get_persistent_data_store_required_params_with_retries(self):
        # Enable retries and run test_get_persistent_data_store_required_params.
        _service.enable_retries()
        self.test_get_persistent_data_store_required_params()

        # Disable retries and run test_get_persistent_data_store_required_params.
        _service.disable_retries()
        self.test_get_persistent_data_store_required_params()

    @responses.activate
    def test_get_persistent_data_store_value_error(self):
        """
        test_get_persistent_data_store_value_error()
        """
        # Set up mock
        url = preprocess_url(
            '/projects/15314cc3-85b4-4338-903f-c28cdee6d005/persistent_data_stores/my-persistent-data-store'
        ...
        for param in req_param_dict.keys():
            req_copy = {key: val if key is not param else None for (key, val) in req_param_dict.items()}
            with pytest.raises(ValueError):
                _service.get_persistent_data_store(**req_copy)

    def test_get_persistent_data_store_value_error_with_retries(self):
        # Enable retries and run test_get_persistent_data_store_value_error.
        _service.enable_retries()
        self.test_get_persistent_data_store_value_error()

        # Disable retries and run test_get_persistent_data_store_value_error.
        _service.disable_retries()
        self.test_get_persistent_data_store_value_error()
...
# endregion
##############################################################################
# End of Service: PersistentDataStores
##############################################################################
...
class TestModel_App:
    ...
    def test_app_serialization(self):
        ...
        volume_mount_model['read_only'] = True
        volume_mount_model['reference'] = 'my-secret'
        volume_mount_model['sub_path'] = 'some-path'
...
class TestModel_AppInstance:
    ...
    def test_app_instance_serialization(self):
        ...
        app_instance_status_details_model = {}  # AppInstanceStatusDetails
        app_instance_status_details_model['system_container'] = container_status_model
        app_instance_status_details_model['user_container'] = container_status_model
        ...
        app_instance_model_json['status_details'] = app_instance_status_details_model
...
class TestModel_AppInstanceList:
    ...
    def test_app_instance_list_serialization(self):
        ...
        app_instance_model['status_details'] = app_instance_status_details_model
...
class TestModel_AppInstanceStatusDetails:
    """
    Test Class for AppInstanceStatusDetails
    """

    def test_app_instance_status_details_serialization(self):
        """
        Test serialization/deserialization for AppInstanceStatusDetails
        """
        ...
        # Construct a json representation of a AppInstanceStatusDetails model
        app_instance_status_details_model_json = {}
        app_instance_status_details_model_json['system_container'] = container_status_model
        app_instance_status_details_model_json['user_container'] = container_status_model

        # Construct a model instance of AppInstanceStatusDetails by calling from_dict on the json representation
        app_instance_status_details_model = AppInstanceStatusDetails.from_dict(app_instance_status_details_model_json)
        assert app_instance_status_details_model != False

        # Construct a model instance of AppInstanceStatusDetails by calling from_dict on the json representation
        app_instance_status_details_model_dict = AppInstanceStatusDetails.from_dict(
            app_instance_status_details_model_json
        ).__dict__
        app_instance_status_details_model2 = AppInstanceStatusDetails(**app_instance_status_details_model_dict)

        # Verify the model instances are equivalent
        assert app_instance_status_details_model == app_instance_status_details_model2

        # Convert model instance back to dict and verify no loss of data
        app_instance_status_details_model_json2 = app_instance_status_details_model.to_dict()
        assert app_instance_status_details_model_json2 == app_instance_status_details_model_json
...
class TestModel_Build:
    ...
    def test_build_serialization(self):
        ...
        build_param_model = {}  # BuildParam
        build_param_model['key'] = 'MY_VARIABLE'
        build_param_model['name'] = 'var-name'
        build_param_model['reference'] = 'my-secret'
        build_param_model['type'] = 'literal'
        build_param_model['value'] = 'some-value'
        ...
        build_model_json['run_build_params'] = [build_param_model]
...
class TestModel_BuildList:
    ...
    def test_build_list_serialization(self):
        ...
        build_model['run_build_params'] = [build_param_model]
...
class TestModel_BuildParam:
    """
    Test Class for BuildParam
    """

    def test_build_param_serialization(self):
        """
        Test serialization/deserialization for BuildParam
        """

        # Construct a json representation of a BuildParam model
        build_param_model_json = {}
        build_param_model_json['key'] = 'MY_VARIABLE'
        build_param_model_json['name'] = 'SOME'
        build_param_model_json['reference'] = 'my-secret'
        build_param_model_json['type'] = 'literal'
        build_param_model_json['value'] = 'VALUE'

        # Construct a model instance of BuildParam by calling from_dict on the json representation
        build_param_model = BuildParam.from_dict(build_param_model_json)
        assert build_param_model != False

        # Construct a model instance of BuildParam by calling from_dict on the json representation
        build_param_model_dict = BuildParam.from_dict(build_param_model_json).__dict__
        build_param_model2 = BuildParam(**build_param_model_dict)

        # Verify the model instances are equivalent
        assert build_param_model == build_param_model2

        # Convert model instance back to dict and verify no loss of data
        build_param_model_json2 = build_param_model.to_dict()
        assert build_param_model_json2 == build_param_model_json


class TestModel_BuildParamPrototype:
    """
    Test Class for BuildParamPrototype
    """

    def test_build_param_prototype_serialization(self):
        """
        Test serialization/deserialization for BuildParamPrototype
        """

        # Construct a json representation of a BuildParamPrototype model
        build_param_prototype_model_json = {}
        build_param_prototype_model_json['key'] = 'MY_VARIABLE'
        build_param_prototype_model_json['name'] = 'SOME'
        build_param_prototype_model_json['reference'] = 'my-secret'
        build_param_prototype_model_json['type'] = 'literal'
        build_param_prototype_model_json['value'] = 'VALUE'

        # Construct a model instance of BuildParamPrototype by calling from_dict on the json representation
        build_param_prototype_model = BuildParamPrototype.from_dict(build_param_prototype_model_json)
        assert build_param_prototype_model != False

        # Construct a model instance of BuildParamPrototype by calling from_dict on the json representation
        build_param_prototype_model_dict = BuildParamPrototype.from_dict(build_param_prototype_model_json).__dict__
        build_param_prototype_model2 = BuildParamPrototype(**build_param_prototype_model_dict)

        # Verify the model instances are equivalent
        assert build_param_prototype_model == build_param_prototype_model2

        # Convert model instance back to dict and verify no loss of data
        build_param_prototype_model_json2 = build_param_prototype_model.to_dict()
        assert build_param_prototype_model_json2 == build_param_prototype_model_json
...
class TestModel_BuildPatch:
    ...
    def test_build_patch_serialization(self):
        ...
        build_param_prototype_model = {}  # BuildParamPrototype
        build_param_prototype_model['key'] = 'MY_VARIABLE'
        build_param_prototype_model['name'] = 'SOME'
        build_param_prototype_model['reference'] = 'my-secret'
        build_param_prototype_model['type'] = 'literal'
        ...
        build_patch_model_json['run_build_params'] = [build_param_prototype_model]
...
class TestModel_BuildRun:
    ...
    def test_build_run_serialization(self):
        ...
        build_run_model_json['run_build_params'] = [build_param_model]
...
class TestModel_BuildRunList:
    ...
    def test_build_run_list_serialization(self):
        ...
        build_run_model['run_build_params'] = [build_param_model]
...
class TestModel_CbrStatus:
    """
    Test Class for CbrStatus
    """

    def test_cbr_status_serialization(self):
        """
        Test serialization/deserialization for CbrStatus
        """
        ...
        enforcement_status_model['inbound_private'] = 'blocked'
        enforcement_status_model['inbound_public'] = 'blocked'
        enforcement_status_model['last_synced_at'] = 'testString'

        # Construct a json representation of a CbrStatus model
        cbr_status_model_json = {}
        cbr_status_model_json['data_plane'] = enforcement_status_model

        # Construct a model instance of CbrStatus by calling from_dict on the json representation
        cbr_status_model = CbrStatus.from_dict(cbr_status_model_json)
        assert cbr_status_model != False

        # Construct a model instance of CbrStatus by calling from_dict on the json representation
        cbr_status_model_dict = CbrStatus.from_dict(cbr_status_model_json).__dict__
        cbr_status_model2 = CbrStatus(**cbr_status_model_dict)

        # Verify the model instances are equivalent
        assert cbr_status_model == cbr_status_model2

        # Convert model instance back to dict and verify no loss of data
        cbr_status_model_json2 = cbr_status_model.to_dict()
        assert cbr_status_model_json2 == cbr_status_model_json
...
class TestModel_EnforcementStatus:
    ...
    def test_enforcement_status_serialization(self):
        """
        Test serialization/deserialization for EnforcementStatus
        """

        # Construct a json representation of a EnforcementStatus model
        enforcement_status_model_json = {}
        enforcement_status_model_json['enforcement'] = 'applied'
        enforcement_status_model_json['inbound_private'] = 'blocked'
        enforcement_status_model_json['inbound_public'] = 'blocked'
        enforcement_status_model_json['last_synced_at'] = 'testString'

        # Construct a model instance of EnforcementStatus by calling from_dict on the json representation
        enforcement_status_model = EnforcementStatus.from_dict(enforcement_status_model_json)
        assert enforcement_status_model != False

        # Construct a model instance of EnforcementStatus by calling from_dict on the json representation
        enforcement_status_model_dict = EnforcementStatus.from_dict(enforcement_status_model_json).__dict__
        enforcement_status_model2 = EnforcementStatus(**enforcement_status_model_dict)

        # Verify the model instances are equivalent
        assert enforcement_status_model == enforcement_status_model2

        # Convert model instance back to dict and verify no loss of data
        enforcement_status_model_json2 = enforcement_status_model.to_dict()
        assert enforcement_status_model_json2 == enforcement_status_model_json
...
class TestModel_Function:
    ...
    def test_function_serialization(self):
        ...
        function_model_json['runtime'] = 'nodejs-24'
...
class TestModel_FunctionList:
    ...
    def test_function_list_serialization(self):
        ...
        function_model['runtime'] = 'nodejs-24'
...
class TestModel_FunctionPatch:
    ...
    def test_function_patch_serialization(self):
        ...
        function_patch_model_json['runtime'] = 'nodejs-24'
...
class TestModel_IndexDetails:
    """
    Test Class for IndexDetails
    """

    def test_index_details_serialization(self):
        """
        Test serialization/deserialization for IndexDetails
        """

        # Construct a json representation of a IndexDetails model
        index_details_model_json = {}

        # Construct a model instance of IndexDetails by calling from_dict on the json representation
        index_details_model = IndexDetails.from_dict(index_details_model_json)
        assert index_details_model != False

        # Construct a model instance of IndexDetails by calling from_dict on the json representation
        index_details_model_dict = IndexDetails.from_dict(index_details_model_json).__dict__
        index_details_model2 = IndexDetails(**index_details_model_dict)

        # Verify the model instances are equivalent
        assert index_details_model == index_details_model2

        # Convert model instance back to dict and verify no loss of data
        index_details_model_json2 = index_details_model.to_dict()
        assert index_details_model_json2 == index_details_model_json
...
class TestModel_JobRun:
    ...
    def test_job_run_serialization(self):
        ...
        index_details_model = {}  # IndexDetails

        job_run_status_model = {}  # JobRunStatus
        job_run_status_model['indices_details'] = {'key1': index_details_model}
...
class TestModel_JobRunStatus:
    ...
    def test_job_run_status_serialization(self):
        ...
        job_run_status_model_json['indices_details'] = {'key1': index_details_model}
...
class TestModel_PersistentDataStore:
    """
    Test Class for PersistentDataStore
    """

    def test_persistent_data_store_serialization(self):
        """
        Test serialization/deserialization for PersistentDataStore
        """

        # Construct dict forms of any model objects needed in order to build this model.

        storage_data_model = {}  # StorageDataObjectStorageData
        storage_data_model['bucket_location'] = 'us-east'
        storage_data_model['bucket_name'] = 'my-bucket'
        storage_data_model['secret_name'] = 'my-secret'
        storage_data_model['foo'] = 'testString'

        # Construct a json representation of a PersistentDataStore model
        persistent_data_store_model_json = {}
        persistent_data_store_model_json['data'] = storage_data_model
        persistent_data_store_model_json['entity_tag'] = '2385407409'
        persistent_data_store_model_json['href'] = (
            'https://api.eu-de.codeengine.cloud.ibm.com/v2/projects/4e49b3e0-27a8-48d2-a784-c7ee48bb863b/persistent_data_stores/my-persistent-data-store'
        )
        persistent_data_store_model_json['name'] = 'my-persistent-data-store'
        persistent_data_store_model_json['storage_type'] = 'object_storage'

        # Construct a model instance of PersistentDataStore by calling from_dict on the json representation
        persistent_data_store_model = PersistentDataStore.from_dict(persistent_data_store_model_json)
        assert persistent_data_store_model != False

        # Construct a model instance of PersistentDataStore by calling from_dict on the json representation
        persistent_data_store_model_dict = PersistentDataStore.from_dict(persistent_data_store_model_json).__dict__
        persistent_data_store_model2 = PersistentDataStore(**persistent_data_store_model_dict)

        # Verify the model instances are equivalent
        assert persistent_data_store_model == persistent_data_store_model2

        # Convert model instance back to dict and verify no loss of data
        persistent_data_store_model_json2 = persistent_data_store_model.to_dict()
        assert persistent_data_store_model_json2 == persistent_data_store_model_json


class TestModel_PersistentDataStoreList:
    """
    Test Class for PersistentDataStoreList
    """

    def test_persistent_data_store_list_serialization(self):
        """
        Test serialization/deserialization for PersistentDataStoreList
        """
        ...
        persistent_data_store_model = {}  # PersistentDataStore
        persistent_data_store_model['data'] = storage_data_model
        persistent_data_store_model['entity_tag'] = '2385407409'
        persistent_data_store_model['href'] = (
            'https://api.eu-de.codeengine.cloud.ibm.com/v2/projects/4e49b3e0-27a8-48d2-a784-c7ee48bb863b/persistent_data_stores/my-persistent-data-store'
        )
        persistent_data_store_model['name'] = 'my-persistent-data-store'
        persistent_data_store_model['storage_type'] = 'object_storage'

        # Construct a json representation of a PersistentDataStoreList model
        persistent_data_store_list_model_json = {}
        persistent_data_store_list_model_json['first'] = list_first_metadata_model
        persistent_data_store_list_model_json['limit'] = 100
        persistent_data_store_list_model_json['next'] = list_next_metadata_model
        persistent_data_store_list_model_json['persistent_data_stores'] = [persistent_data_store_model]

        # Construct a model instance of PersistentDataStoreList by calling from_dict on the json representation
        persistent_data_store_list_model = PersistentDataStoreList.from_dict(persistent_data_store_list_model_json)
        assert persistent_data_store_list_model != False

        # Construct a model instance of PersistentDataStoreList by calling from_dict on the json representation
        persistent_data_store_list_model_dict = PersistentDataStoreList.from_dict(
            persistent_data_store_list_model_json
        ).__dict__
        persistent_data_store_list_model2 = PersistentDataStoreList(**persistent_data_store_list_model_dict)

        # Verify the model instances are equivalent
        assert persistent_data_store_list_model == persistent_data_store_list_model2

        # Convert model instance back to dict and verify no loss of data
        persistent_data_store_list_model_json2 = persistent_data_store_list_model.to_dict()
...
class TestModel_ProjectStatusDetails:
    ...
    def test_project_status_details_serialization(self):
        ...
        enforcement_status_model = {}  # EnforcementStatus
        enforcement_status_model['enforcement'] = 'applied'
        enforcement_status_model['inbound_private'] = 'allowed'
        enforcement_status_model['inbound_public'] = 'allowed'
        ...
        project_status_details_model_json['cbr'] = cbr_status_model
        project_status_details_model_json['domain'] = 'unknown'
        project_status_details_model_json['project'] = 'enabled'
        project_status_details_model_json['vpe'] = 'ready'
...
class TestModel_VolumeMount:
    ...
    def test_volume_mount_serialization(self):
        ...
        volume_mount_model_json['read_only'] = True
        volume_mount_model_json['reference'] = 'my-secret'
        volume_mount_model_json['sub_path'] = 'some-path'
...
class TestModel_VolumeMountPrototype:
    ...
    def test_volume_mount_prototype_serialization(self):
        ...
        volume_mount_prototype_model_json['read_only'] = True
        volume_mount_prototype_model_json['reference'] = 'my-secret'
        volume_mount_prototype_model_json['sub_path'] = 'some-path'
...
class TestModel_StorageDataObjectStorageData:
    """
    Test Class for StorageDataObjectStorageData
    """

    def test_storage_data_object_storage_data_serialization(self):
        """
        Test serialization/deserialization for StorageDataObjectStorageData
        """
        ...
        # Construct a model instance of StorageDataObjectStorageData by calling from_dict on the json representation
        storage_data_object_storage_data_model = StorageDataObjectStorageData.from_dict(
            storage_data_object_storage_data_model_json
        )
        assert storage_data_object_storage_data_model != False

        # Construct a model instance of StorageDataObjectStorageData by calling from_dict on the json representation
        storage_data_object_storage_data_model_dict = StorageDataObjectStorageData.from_dict(
            storage_data_object_storage_data_model_json
        ).__dict__
        storage_data_object_storage_data_model2 = StorageDataObjectStorageData(
            **storage_data_object_storage_data_model_dict
        )

        # Verify the model instances are equivalent
        assert storage_data_object_storage_data_model == storage_data_object_storage_data_model2

        # Convert model instance back to dict and verify no loss of data
        storage_data_object_storage_data_model_json2 = storage_data_object_storage_data_model.to_dict()
        assert storage_data_object_storage_data_model_json2 == storage_data_object_storage_data_model_json

        # Test get_properties and set_properties methods.
        storage_data_object_storage_data_model.set_properties({})
        actual_dict = storage_data_object_storage_data_model.get_properties()
        assert actual_dict == {}

        expected_dict = {'foo': 'testString'}
        storage_data_object_storage_data_model.set_properties(expected_dict)
        actual_dict = storage_data_object_storage_data_model.get_properties()
        assert actual_dict.keys() == expected_dict.keys()
